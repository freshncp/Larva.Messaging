...
namespace Larva.Messaging
{
    ...
    /// 处理消息成功 事件参数
    /// </summary>
    public class MessageHandlingSucceededEventArgs : EventArgs
    {
        /// <summary>
        /// 处理消息成功 事件参数
        /// </summary>
        ...
        public MessageHandlingSucceededEventArgs(string messageHandlerCategory, MessageReceiverType receiverType, IMessageTransportationContext context)
        {
